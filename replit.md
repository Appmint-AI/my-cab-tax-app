...
- **Tax Summary & Export**: Aggregates expenses by IRS Schedule C categories. Exports tax summaries as ZIP archives containing a Schedule C Summary (TXT) and CSVs for expenses and mileage logs, marked with "Self-Prepared / Not Audited."
- **Tiered Pricing (Basic/Pro)**: Integrated with Stripe for subscription management. Pro features include extended receipt retention (Tax Vault), AI receipt scanning, and smart sales importing. Basic users have limited data retention.
